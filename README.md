...
includes a live Mermaid diagram that visualizes the DevOps flow (trigger → pipeline → each gate → aggregator). This lets you
see pass/fail details and the pipeline topology directly on the run page without downloading artifacts. You can still
